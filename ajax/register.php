...
if (isset($_POST['full_name'])) {
    $fields = array(
        ...
        array('field_name'=>'entry_type',     'required'=>true,   'type'=>'specific', 'defaults'=>array('entry', 'half-entry', 'full-entry', 'sponsor')),
        array('field_name'=>'entry_location', 'required'=>true,   'type'=>'specific', 'defaults'=>array('pe', 'ct')),
        array('field_name'=>'meals',          'required'=>false,  'type'=>'specific', 'defaults'=>array('sabbath', 'sunday', 'monday')),
        ...
        array('field_name'=>'newsletter',     'required'=>false,  'type'=>'specific', 'defaults'=>array('monthly', 'conf_updates'))
    );
    ...
    if ($validate->valid()) {
        ...
        echo json_encode(array('yay'=>'wotsup'));
    }
    header("HTTP/1.1 400 AMEN say no no!!", TRUE, 400);
